...
Revision ID: 741fd3826445
Revises: 
Create Date: 2022-12-18 18:24:07.623781
...
def upgrade():
    ...
    sa.Column('av_start', sa.DateTime(), nullable=False),
    sa.Column('av_end', sa.DateTime(), nullable=False),
